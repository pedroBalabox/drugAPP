    ...
    return Align(
      ...
      child: Column(
        ...
        children: [
          ...
          Padding(
            padding: EdgeInsets.symmetric(vertical: medPadding, horizontal: MediaQuery.of(context).size.width / 3),
            child: SimpleButtom(mainText: 'Ver categorias', gcolor: gradientBlueDark),
          )
        ],
      ),
    );
